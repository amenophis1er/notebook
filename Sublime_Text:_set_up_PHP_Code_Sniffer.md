...
```
Everytime you want to save, you'll get a pop up with warning.... You need to fix theme manually

# Go beyond and install an automatic fixer
---

### Install
Install PHP CS Fixer with composer following this guide: `https://github.com/FriendsOfPHP/PHP-CS-Fixer`
To install globally:
`composer global -i friendsofphp/php-cs-fixer`
Be sure everything is working properly:
`php-cs-fixer fix /path/project --rules=@PSR2`

### Create set up Sublime
Create a build script in Sublime text. The easiest way is to create a sublime text projet file in your projet root folder: `Projet > Save As`
...
```
To learn more about Sublime Text Porjet file: https://www.sublimetext.com/docs/projects.html
### Usage
In every php file, just run `CTRL` `+` `B` or `CTRL` `+` `B` to auto fix.
